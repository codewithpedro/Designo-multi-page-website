...
import aboutHero from "../../../img/image-about-hero.jpg";
import worldClass from "../../../img/image-world-class-talent.jpg";
import realDeal from "../../../img/image-real-deal.jpg";
      ...
      <div className="about">
        <div className="about-us">
          <div className="container full">
            <img src={aboutHero} className="desktop-img" alt="computers, tables, journals on desk"/>
        ...
        <div className="talent">
          <div className="container full">
            <img src={worldClass} className="desktop-img" alt="women looking at photographs" />
            <div className="content">
        ...
        <div className="deal">
          <div className="container full">
            <img src={realDeal} className="desktop-img" alt="women looking at photographs" />
            <div className="content">
              <h1>The real deal</h1>
